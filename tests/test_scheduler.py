...
from app.analysis import (
    ...
    get_demo_loop_schedule_state as packaged_get_demo_loop_schedule_state,
    get_next_entry_window_start_ny,
)
from app.analysis.scheduler import get_demo_loop_schedule_state
...
class SchedulerStateTests(unittest.TestCase):
    def test_app_analysis_init_reexports_scheduler_functions(self):
        self.assertIs(packaged_get_demo_loop_schedule_state, get_demo_loop_schedule_state)
